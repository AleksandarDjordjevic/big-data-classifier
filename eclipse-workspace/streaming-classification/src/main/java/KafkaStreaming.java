...
public class KafkaStreaming {
    public static  void main(String arr[]) throws InterruptedException
    {
        ...
        conf.set("spark.app.name", "Spark Streaming"); //The name of application. This will appear in the UI and in log data.
        ...
        // Create the context with 5 seconds batch size
